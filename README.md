...
# Analyst
analyst_code.R contains the R code written to assign cell types to the respective clusters generated by the programmer code. The input file is a Seurat object. Required packages are listed in the file. Heatmaps and feature, violin, and UMAP projection plots are generated depicting marker gene enrichment according to cell type.
